...
class FilialController {
    ...
    // Adicionar ao FilialController.php

    public function relatorios() {
        $filial_id = $_SESSION['filial_id'];
        
        $vendasPorMes = $this->db->fetchAll("
        ...
        $produtosAnalise = $this->db->fetchAll("
            SELECT p.nome, SUM(v.quantidade) as total_vendido,
                CASE 
                    WHEN SUM(v.quantidade) > 100 THEN 'Alta demanda'
                    WHEN SUM(v.quantidade) > 50 THEN 'Demanda média'
                    ELSE 'Baixa demanda'
        ...
        include __DIR__ . '/../views/filial/relatorios.php';
    }
}
?>