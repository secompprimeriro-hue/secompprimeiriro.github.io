...
<body>
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="index.php?action=matriz_vendas" class="active"><i class="fas fa-chart-simple"></i> Vendas</a>
        </div>
    </div>
    ...
    <div class="main-content">
        <div class="top-bar">
            <div class="page-title">
                ...
                <p>Acompanhe todas as vendas em tempo real</p>
            </div>
            <div class="user-info">
